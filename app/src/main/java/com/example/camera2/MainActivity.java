...
public class MainActivity extends AppCompatActivity {
    ...
    private static SparseIntArray ORINTATIONS = new SparseIntArray();

    static {
        ORINTATIONS.append(Surface.ROTATION_0, 0);
        ORINTATIONS.append(Surface.ROTATION_90, 90);
        ORINTATIONS.append(Surface.ROTATION_180, 180);
        ORINTATIONS.append(Surface.ROTATION_270, 270);
    }
    ...
    private void startBackgroundThread() {
        mBackgroundHandlerThread = new HandlerThread("Camera 2");
    ...
    private static int sensorToDeviceRotation(CameraCharacteristics cameraCharacteristics, int deviceOrientation) {
        ...
        deviceOrientation = ORINTATIONS.get(deviceOrientation);
